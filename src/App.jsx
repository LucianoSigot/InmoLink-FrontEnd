  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Cambiamos 'alquilo' por 'alquiler' para que coincida con la URL que genera el Home */}
        ...
        {/* Mantenemos las demás rutas por compatibilidad */}
        <Route path="/perfil/alquilo" element={<RutaProtegida><Alquilo /></RutaProtegida>} />
        <Route path="/reserva" element={<RutaProtegida><Reserva /></RutaProtegida>} />
        <Route path="/alquilo" element={<RutaProtegida><Alquilo /></RutaProtegida>} />

        <Route path="/publicar" element={<RutaProtegida><CrearPublicacion /></RutaProtegida>} />
        <Route path="/anuncio" element={<RutaProtegida><Anuncio /></RutaProtegida>} />
