...
const Propiedad = ({ propiedad }) => {
  ...
  // Validamos que 'propiedad' exista para evitar errores
  if (!propiedad) {
    return null; 
  }

  // Lógica de Imagen: Usa la primera foto o un placeholder
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="flex items-center justify-between mt-auto text-gray-600 text-sm">
          ...
          <div className="flex items-center gap-2" title="Metros Cuadrados">
            ...
            <span className="font-medium">{propiedad.m2 || 0} m²</span>
          </div>
